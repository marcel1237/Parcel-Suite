...
Calamares não será combinado com Subiquity no mesmo fluxo. Uma futura prova de
conceito com Calamares deverá ser uma variante independente da ISO e terá que
fornecer configuração completa de payload, particionamento e bootloader.

Anaconda e archinstall não serão utilizados no MVP: o primeiro é alinhado ao
ecossistema RPM/DNF e o segundo instala Arch Linux.
...
Essas funcionalidades somente voltarão ao escopo depois que a instalação mínima
offline for reproduzível e testada em máquina virtual.
